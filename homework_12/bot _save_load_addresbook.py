...
def main():
    ...
    while True:
        ...
        if command in commands:
            if command == 'save':
                filename = input('Enter filename to save the address book: ')
                commands[command](address_book, filename)
            elif command == 'load':
                filename = input('Enter filename to load the address book: ')
                address_book = commands[command](filename)
            else:
...
def print_commands():
    ...
    print('save - Save the address book to a file')
    print('load - Load the address book from a file')
